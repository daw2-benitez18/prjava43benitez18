package prjava43benitez18;
import java.awt.*;        // using AWT containers and components
import java.awt.event.*;
import java.net.*;// using AWT events and listener interfaces
 
// An AWT GUI program inherits the top-level container java.awt.Frame
public class Prjava43benitez18 extends Frame
   ...
   public Prjava43benitez18 () {
      ...
      setTitle("nova finestra prjava43benitez18");  // "this" Frame sets title
   ...
   public static void main(String[] args) {
      new Prjava43benitez18();  // Let the construct do the job
   }
